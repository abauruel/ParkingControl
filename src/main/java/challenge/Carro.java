...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        if(placa==null||placa.isEmpty()) throw new NullPointerException();
        if(cor==null) throw new NullPointerException();
        if(motorista==null) throw new EstacionamentoException("Nao permitido carro autonomo");
    ...
    public static class CarroBuilder {
        ...
        public CarroBuilder withMotorista(Motorista motorista) {
            if(motorista==null) throw new EstacionamentoException("Nao permitido carro anonimo");
            this.motorista = motorista;
            return this;
        }
